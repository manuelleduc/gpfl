		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getXbaseXLiteralAccess().getAlternatives(), "superXLiteral__Alternatives");
					...
					put(grammarAccess.getStmtAccess().getExpAssignment_1_3(), "rule__Stmt__ExpAssignment_1_3");
					put(grammarAccess.getStmtAccess().getStmtsAssignment_1_5(), "rule__Stmt__StmtsAssignment_1_5");
					put(grammarAccess.getStmtAccess().getExpAssignment_2_3(), "rule__Stmt__ExpAssignment_2_3");
					put(grammarAccess.getStmtAccess().getStmtsAssignment_2_5(), "rule__Stmt__StmtsAssignment_2_5");
					put(grammarAccess.getStmtAccess().getTimeoutAssignment_3_3(), "rule__Stmt__TimeoutAssignment_3_3");
					put(grammarAccess.getStmtAccess().getPeriodicAssignment_3_5(), "rule__Stmt__PeriodicAssignment_3_5");
					put(grammarAccess.getStmtAccess().getStmtsAssignment_3_7(), "rule__Stmt__StmtsAssignment_3_7");
