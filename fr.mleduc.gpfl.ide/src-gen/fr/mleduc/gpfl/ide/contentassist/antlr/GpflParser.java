 ...
 */
package fr.mleduc.gpfl.ide.contentassist.antlr;

import com.google.inject.Inject;
import fr.mleduc.gpfl.ide.contentassist.antlr.internal.InternalGpflParser;
...
public class GpflParser extends AbstractContentAssistParser {
	...
	@Override
	protected InternalGpflParser createParser() {
		InternalGpflParser result = new InternalGpflParser(null);
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getGExpressionAccess().getGroup_1(), "rule__GExpression__Group_1__0");
					put(grammarAccess.getGExpressionAccess().getGroup_2(), "rule__GExpression__Group_2__0");
					put(grammarAccess.getGExpressionAccess().getGroup_3(), "rule__GExpression__Group_3__0");
					...
					put(grammarAccess.getGExpressionAccess().getExpAssignment_1_3(), "rule__GExpression__ExpAssignment_1_3");
					put(grammarAccess.getGExpressionAccess().getStmtsAssignment_1_5(), "rule__GExpression__StmtsAssignment_1_5");
					put(grammarAccess.getGExpressionAccess().getExpAssignment_2_3(), "rule__GExpression__ExpAssignment_2_3");
					put(grammarAccess.getGExpressionAccess().getStmtsAssignment_2_5(), "rule__GExpression__StmtsAssignment_2_5");
					put(grammarAccess.getGExpressionAccess().getTimeoutAssignment_3_3(), "rule__GExpression__TimeoutAssignment_3_3");
					put(grammarAccess.getGExpressionAccess().getPeriodicAssignment_3_5(), "rule__GExpression__PeriodicAssignment_3_5");
					put(grammarAccess.getGExpressionAccess().getStmtsAssignment_3_7(), "rule__GExpression__StmtsAssignment_3_7");
