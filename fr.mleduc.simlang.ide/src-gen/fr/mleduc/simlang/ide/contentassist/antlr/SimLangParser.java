 ...
 */
package fr.mleduc.simlang.ide.contentassist.antlr;

import com.google.inject.Inject;
import fr.mleduc.simlang.ide.contentassist.antlr.internal.InternalSimLangParser;
...
public class SimLangParser extends AbstractContentAssistParser {
	...
	@Override
	protected InternalSimLangParser createParser() {
		InternalSimLangParser result = new InternalSimLangParser(null);
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getXbaseXPrimaryExpressionAccess().getAlternatives(), "superXPrimaryExpression__Alternatives");
					...
					put(grammarAccess.getRootBlockExpressionAccess().getGroup(), "rule__RootBlockExpression__Group__0");
					...
					put(grammarAccess.getProgramAccess().getInitAssignment_5_1(), "rule__Program__InitAssignment_5_1");
					put(grammarAccess.getProgramAccess().getBodyAssignment_7(), "rule__Program__BodyAssignment_7");
					put(grammarAccess.getRootBlockExpressionAccess().getExpressionsAssignment_1_0(), "rule__RootBlockExpression__ExpressionsAssignment_1_0");
					...
					put(grammarAccess.getXPrimaryExpressionAccess().getIfAssignment_1_3(), "rule__XPrimaryExpression__IfAssignment_1_3");
					put(grammarAccess.getXPrimaryExpressionAccess().getThenAssignment_1_5(), "rule__XPrimaryExpression__ThenAssignment_1_5");
					put(grammarAccess.getXPrimaryExpressionAccess().getExpAssignment_2_3(), "rule__XPrimaryExpression__ExpAssignment_2_3");
					put(grammarAccess.getXPrimaryExpressionAccess().getBodyAssignment_2_5(), "rule__XPrimaryExpression__BodyAssignment_2_5");
	...
	public SimLangGrammarAccess getGrammarAccess() {
