 ...
 */
package fr.mleduc.gpfl.sequence.services;
...
public class SequenceGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class ModelElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "fr.mleduc.gpfl.sequence.Sequence.Model");
	...
	public class EventElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "fr.mleduc.gpfl.sequence.Sequence.Event");
		private final Group cGroup = (Group)rule.eContents().get(1);
		...
		private final RuleCall cDirectionPortParserRuleCall_1_0 = (RuleCall)cDirectionAssignment_1.eContents().get(0);
		private final Assignment cValuesAssignment_2 = (Assignment)cGroup.eContents().get(2);
		private final RuleCall cValuesFieldParserRuleCall_2_0 = (RuleCall)cValuesAssignment_2.eContents().get(0);
		...
		//Port
		public RuleCall getDirectionPortParserRuleCall_1_0() { return cDirectionPortParserRuleCall_1_0; }
		
		//values+=Field*
		public Assignment getValuesAssignment_2() { return cValuesAssignment_2; }
		
		//Field
		public RuleCall getValuesFieldParserRuleCall_2_0() { return cValuesFieldParserRuleCall_2_0; }
	}
	public class FieldElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "fr.mleduc.gpfl.sequence.Sequence.Field");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class PortElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "fr.mleduc.gpfl.sequence.Sequence.Port");
	...
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		...
		while (grammar != null) {
			if ("fr.mleduc.gpfl.sequence.Sequence".equals(grammar.getName())) {
				return grammar;
			}
