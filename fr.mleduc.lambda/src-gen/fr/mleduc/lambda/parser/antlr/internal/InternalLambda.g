...
@after {
	...
	(
		...
		{
			$current = $this_GExpression_11.current;
			afterParserOrEnumRuleCall();
		}
		    |
		(
...
entrySuperGExpression returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getGpflGExpressionRule()); }
	iv_superGExpression=superGExpression
	{ $current=$iv_superGExpression.current; }
	EOF;

// Rule GExpression
superGExpression returns [EObject current=null]
@init {
	enterRule();
}
@after {
