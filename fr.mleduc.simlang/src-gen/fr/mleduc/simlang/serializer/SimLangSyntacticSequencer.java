...
public class SimLangSyntacticSequencer extends AbstractSyntacticSequencer {

	protected SimLangGrammarAccess grammarAccess;
	protected AbstractElementAlias match_RootBlockExpression_SemicolonKeyword_1_1_q;
	...
	protected void init(IGrammarAccess access) {
		grammarAccess = (SimLangGrammarAccess) access;
		match_RootBlockExpression_SemicolonKeyword_1_1_q = new TokenAlias(false, true, grammarAccess.getRootBlockExpressionAccess().getSemicolonKeyword_1_1());
	...
	protected void emitUnassignedTokens(EObject semanticObject, ISynTransition transition, INode fromNode, INode toNode) {
		...
		for (AbstractElementAlias syntax : transition.getAmbiguousSyntaxes()) {
			...
			if (match_RootBlockExpression_SemicolonKeyword_1_1_q.equals(syntax))
				emit_RootBlockExpression_SemicolonKeyword_1_1_q(semanticObject, getLastNavigableState(), syntaxNodes);
	 ...
	 */
	protected void emit_RootBlockExpression_SemicolonKeyword_1_1_q(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
