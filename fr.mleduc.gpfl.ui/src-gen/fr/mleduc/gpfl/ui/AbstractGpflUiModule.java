...
import fr.mleduc.gpfl.ide.contentassist.antlr.GpflParser;
import fr.mleduc.gpfl.ide.contentassist.antlr.PartialGpflContentAssistParser;
import fr.mleduc.gpfl.ide.contentassist.antlr.internal.InternalGpflLexer;
import fr.mleduc.gpfl.ui.contentassist.GpflProposalProvider;
import fr.mleduc.gpfl.ui.labeling.GpflDescriptionLabelProvider;
import fr.mleduc.gpfl.ui.labeling.GpflLabelProvider;
import fr.mleduc.gpfl.ui.outline.GpflOutlineTreeProvider;
import fr.mleduc.gpfl.ui.quickfix.GpflQuickfixProvider;
...
/**
 * Manual modifications go to {@link GpflUiModule}.
 */
@SuppressWarnings("all")
public abstract class AbstractGpflUiModule extends DefaultXbaseUiModule {

	public AbstractGpflUiModule(AbstractUIPlugin plugin) {
		super(plugin);
	}
	...
	public void configureHighlightingLexer(Binder binder) {
		binder.bind(org.eclipse.xtext.parser.antlr.Lexer.class)
			...
			.to(fr.mleduc.gpfl.parser.antlr.internal.InternalGpflLexer.class);
	}
	...
	public void configureContentAssistLexerProvider(Binder binder) {
		binder.bind(InternalGpflLexer.class).toProvider(LexerProvider.create(InternalGpflLexer.class));
	}
	...
	public Class<? extends ILabelProvider> bindILabelProvider() {
		return GpflLabelProvider.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.labeling.LabelProviderFragment2
	public void configureResourceUIServiceLabelProvider(Binder binder) {
		binder.bind(ILabelProvider.class).annotatedWith(ResourceServiceDescriptionLabelProvider.class).to(GpflDescriptionLabelProvider.class);
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.outline.OutlineTreeProviderFragment2
	public Class<? extends IOutlineTreeProvider> bindIOutlineTreeProvider() {
		return GpflOutlineTreeProvider.class;
	}
	...
	public Class<? extends IssueResolutionProvider> bindIssueResolutionProvider() {
		return GpflQuickfixProvider.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.contentAssist.ContentAssistFragment2
	public Class<? extends IContentProposalProvider> bindIContentProposalProvider() {
		return GpflProposalProvider.class;
	}
	...
	public Class<? extends IPartialEditingContentAssistParser> bindIPartialEditingContentAssistParser() {
		return PartialGpflContentAssistParser.class;
	}
	...
	public void configureCompareViewerTitle(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(UIBindings.COMPARE_VIEWER_TITLE)).toInstance("Gpfl Compare");
	}
