 ...
 */
package fr.mleduc.gpfl.sequence.ide.contentassist.antlr;

import com.google.inject.Inject;
import fr.mleduc.gpfl.sequence.ide.contentassist.antlr.internal.InternalSequenceParser;
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getModelAccess().getEventsAssignment_2(), "rule__Model__EventsAssignment_2");
					put(grammarAccess.getEventAccess().getTimeAssignment_0(), "rule__Event__TimeAssignment_0");
					put(grammarAccess.getEventAccess().getDirectionAssignment_1(), "rule__Event__DirectionAssignment_1");
					put(grammarAccess.getEventAccess().getValuesAssignment_2(), "rule__Event__ValuesAssignment_2");
