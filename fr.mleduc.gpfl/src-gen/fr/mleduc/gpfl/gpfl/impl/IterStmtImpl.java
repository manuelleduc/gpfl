 ...
 * @generated
 */
public class IterStmtImpl extends GExpressionImpl implements IterStmt
{
  /**
  ...
  public EList<GExpression> getStmts()
  {
    if (stmts == null)
    {
      stmts = new EObjectContainmentEList<GExpression>(GExpression.class, this, GpflPackage.ITER_STMT__STMTS);
    }
    return stmts;
  }
