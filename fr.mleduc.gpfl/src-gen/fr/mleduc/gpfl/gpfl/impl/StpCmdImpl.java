 ...
 * @generated
 */
public class StpCmdImpl extends GExpressionImpl implements StpCmd
{
  /**
   ...
   * @ordered
   */
  protected EList<GExpression> errors;
   ...
   * @generated
   */
  public NotificationChain basicSetEvent(GExpression newEvent, NotificationChain msgs)
  {
    GExpression oldEvent = event;
    event = newEvent;
    if (eNotificationRequired())
    {
   ...
   * @generated
   */
  public void setEvent(GExpression newEvent)
  {
    if (newEvent != event)
    {
   ...
   * @generated
   */
  public EList<GExpression> getErrors()
  {
    if (errors == null)
    {
      errors = new EObjectContainmentEList<GExpression>(GExpression.class, this, GpflPackage.STP_CMD__ERRORS);
    }
    return errors;
  }
  ...
  public void eSet(int featureID, Object newValue)
  {
    switch (featureID)
    {
      case GpflPackage.STP_CMD__AUTOMATON:
        ...
        return;
      case GpflPackage.STP_CMD__EVENT:
        setEvent((GExpression)newValue);
        return;
      case GpflPackage.STP_CMD__ERRORS:
        getErrors().clear();
        getErrors().addAll((Collection<? extends GExpression>)newValue);
        return;
    }
