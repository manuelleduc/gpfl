 ...
 * </p>
 * <ul>
 *   <li>{@link fr.mleduc.gpfl.gpfl.IterStmt#getExp <em>Exp</em>}</li>
 *   <li>{@link fr.mleduc.gpfl.gpfl.IterStmt#getStmts <em>Stmts</em>}</li>
 * </ul>
 *
 * @see fr.mleduc.gpfl.gpfl.GpflPackage#getIterStmt()
 * @model
 * @generated
 */
public interface IterStmt extends GExpression
{
  /**
   ...
   * @see fr.mleduc.gpfl.gpfl.GpflPackage#getIterStmt_Exp()
  ...
  /**
   * Sets the value of the '{@link fr.mleduc.gpfl.gpfl.IterStmt#getExp <em>Exp</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see fr.mleduc.gpfl.gpfl.GpflPackage#getIterStmt_Stmts()
   * @model containment="true"
   * @generated
   */
