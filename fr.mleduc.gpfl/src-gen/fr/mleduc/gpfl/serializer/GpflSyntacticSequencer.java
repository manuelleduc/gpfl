...
public class GpflSyntacticSequencer extends AbstractSyntacticSequencer {
	...
	protected void emitUnassignedTokens(EObject semanticObject, ISynTransition transition, INode fromNode, INode toNode) {
		...
		for (AbstractElementAlias syntax : transition.getAmbiguousSyntaxes()) {
			...
			if (match_Program_AUTOMATASKeyword_4_0_q.equals(syntax))
	 ...
	 *     name=ID 'PROLOGUE' (ambiguity) 'INIT' initStmts+=Stmt
	 *     name=ID 'PROLOGUE' (ambiguity) 'INIT'? 'FILTER' (rule end)
	 *     name=ID 'PROLOGUE' (ambiguity) 'INIT'? 'FILTER' stmts+=Stmt
	 */
	 ...
	 *     automatas+=AutomataDef (ambiguity) 'FILTER' stmts+=Stmt
	 *     name=ID 'PROLOGUE' 'AUTOMATAS'? (ambiguity) 'FILTER' (rule end)
	 *     name=ID 'PROLOGUE' 'AUTOMATAS'? (ambiguity) 'FILTER' stmts+=Stmt
	 */
	 ...
	 *     (rule start) (ambiguity) 'inSide' (rule start)
