...
import fr.mleduc.simlang.ide.contentassist.antlr.PartialSimLangContentAssistParser;
...
import fr.mleduc.simlang.ui.contentassist.SimLangProposalProvider;
import fr.mleduc.simlang.ui.labeling.SimLangDescriptionLabelProvider;
import fr.mleduc.simlang.ui.labeling.SimLangLabelProvider;
import fr.mleduc.simlang.ui.outline.SimLangOutlineTreeProvider;
import fr.mleduc.simlang.ui.quickfix.SimLangQuickfixProvider;
...
/**
 * Manual modifications go to {@link SimLangUiModule}.
 */
@SuppressWarnings("all")
public abstract class AbstractSimLangUiModule extends DefaultXbaseUiModule {

	public AbstractSimLangUiModule(AbstractUIPlugin plugin) {
		super(plugin);
	}
	...
	public void configureHighlightingLexer(Binder binder) {
		binder.bind(org.eclipse.xtext.parser.antlr.Lexer.class)
			...
			.to(fr.mleduc.simlang.parser.antlr.internal.InternalSimLangLexer.class);
	}
	...
	public void configureContentAssistLexerProvider(Binder binder) {
		binder.bind(InternalSimLangLexer.class).toProvider(LexerProvider.create(InternalSimLangLexer.class));
	}
	...
	public Class<? extends ILabelProvider> bindILabelProvider() {
		return SimLangLabelProvider.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.labeling.LabelProviderFragment2
	public void configureResourceUIServiceLabelProvider(Binder binder) {
		binder.bind(ILabelProvider.class).annotatedWith(ResourceServiceDescriptionLabelProvider.class).to(SimLangDescriptionLabelProvider.class);
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.outline.OutlineTreeProviderFragment2
	public Class<? extends IOutlineTreeProvider> bindIOutlineTreeProvider() {
		return SimLangOutlineTreeProvider.class;
	}
	...
	public Class<? extends IssueResolutionProvider> bindIssueResolutionProvider() {
		return SimLangQuickfixProvider.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.contentAssist.ContentAssistFragment2
	public Class<? extends IContentProposalProvider> bindIContentProposalProvider() {
		return SimLangProposalProvider.class;
	}
	...
	public Class<? extends IPartialEditingContentAssistParser> bindIPartialEditingContentAssistParser() {
		return PartialSimLangContentAssistParser.class;
	}
	...
	public void configureCompareViewerTitle(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(UIBindings.COMPARE_VIEWER_TITLE)).toInstance("SimLang Compare");
	}
