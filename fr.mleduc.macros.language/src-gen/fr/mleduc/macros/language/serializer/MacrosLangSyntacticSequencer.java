...
public class MacrosLangSyntacticSequencer extends AbstractSyntacticSequencer {

	protected MacrosLangGrammarAccess grammarAccess;
	...
	protected void init(IGrammarAccess access) {
		grammarAccess = (MacrosLangGrammarAccess) access;
