 ...
 * @generated
 */
public class LambdaFsmSwitch<T> extends Switch<T>
{
  /**
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      ...
      case LambdaFsmPackage.METHOD_DEF:
      {
        ...
        if (result == null) result = caseState(methodDef);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case LambdaFsmPackage.METHOD_CALL:
      {
        ...
        if (result == null) result = caseState(methodCall);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
